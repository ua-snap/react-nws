...
After cloning this repo, ensure that you have `nvm` installed and are using NodeJS 8.5.0.
...
Enter the directory of the cloned repository, then:
...
See directions below for installing Expo on your phone, then scan the QR code and the application should load.

# Boilerplate README from project scaffolding
